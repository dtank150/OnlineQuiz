...
if(isset($_POST['btnok']))
{
	...
	$q="INSERT INTO category values('','$nm','$fl')";
				...
				<div class="inner_content">
				    <div class="inner_content_w3_agile_info">
					 ...
					 <h2 class="w3_inner_tittle">Add New Category</h2>
									...
									<div class="col-sm-9"> 
										<input type="text" name="nmtxt" class="form-control" id="inputEmail3" placeholder="Email"> 
									</div> 
									</div> 
									<div class="form-group"> 
										<label for="inputPassword3" class="col-sm-2 control-label">Image</label> 
									<div class="col-sm-9"> 
										<input type="file" name="flimg" class="form-control" id="inputPassword3" placeholder="Password"> 
									</div> 
									</div> 
