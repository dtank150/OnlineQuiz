									...
									<a href="addcategory.php" style="float:right"><b><u>Add new Category</u></b></a>
										...
										<?php
										 while($r=mysqli_fetch_array($c))
										 {
											...
											<tr>
												<td align="center"><?php echo $r['cat_id'];?></td>
												...
												&nbsp;&nbsp;
												<a onclick="return confirm('Are You Sure you want to delete this records?')" href="deletecategory.php?id=<?php echo $r['cat_id'];?>">
