...
if(isset($_POST['btnlog']))
{
	...
	$pw=$_POST['password'];
		...
		$q="SELECT * FROM registration WHERE email = '$un' and password = '$pw'";
...
if(isset($_POST['btnreg']))
{
	...
	if($pwd==$cpwd)
	{	
		$q="insert into registration values('','$nm','$gen','$clg','$em','$mob','$pwd')";
		$rs=mysqli_query($cn,$q);
		if ($rs)
		{
			?>
  ...
  <div class="col-md-6">
    <input id="password" name="password" placeholder="Enter your Password" class="form-control input-md" type="password">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="btnlog">Log in</button>
		</fieldset>
</form>
      </div>
    </div><!-- /.modal-content -->
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" class="sub" name="btnreg" value="sign up" class="btn btn-primary"/>
  </div>
</div>
